...
public class Controller {
	...
	public static Controller getInstance() {
		if (theOne == null) {
			...
			try {
				...
				ArrayList<ArrayList<String>> resultList = theOne.mUserDB.getAllRecords();
				...
				resultList = theOne.mVideoGameDB.getAllRecords();
				for(ArrayList<String> values: resultList)
				{
					int id = Integer.parseInt(values.get(0));
					String name = values.get(1);
	...
	public String signInUser(String email, String password) {
		for (User u : theOne.mAllUsersList)
			...
			{
				try {
				    ArrayList<ArrayList<String>> resultList = theOne.mUserDB.getRecord(String.valueOf(u.getId()));
					String storedPassword = resultList.get(0).get(4);
	...
	public ObservableList<VideoGame> getGamesForCurrentUser()
	{
		...
		{
			try {
			    ArrayList<ArrayList<String>> resultList = theOne.mUserGamesDB.getRecord(String.valueOf(mCurrentUser.getId()));
			    for(ArrayList<String> values: resultList) {
